            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    ...
                    <div class="money-bag-icon d-flex align-items-center justify-content-start mb-2">
                        <img src="<?php echo e(asset('/assets/images/money-02.png')); ?>" alt="">
                    </div>
...
<?php echo $__env->make('layouts.layout-with-sidebar-owner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\otod\resources\views/vetc.blade.php ENDPATH**/ ?>