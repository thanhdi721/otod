...
<?php $__env->startSection('content'); ?>
    <!-- Notification -->
    <?php if(request()->get('notification') == 'car_ready'): ?>
        ...
        <div class=" wallet-summary-card border-0">
            <div class="">
                <div class="card-title d-flex  justify-content-between shadow-sm px-3 py-3" style="height:90px;">
                    <div class="">
                        <img src="<?php echo e(asset('/assets/images/money-ic.png')); ?>" alt="">
            ...
            <div class="row g-3">
                <div class="col-6 col-lg-6">
                    <div class="d-flex flex-column gap-2 p-3 rounded" style="background:#F4F4F4">
                        <div>
                            <img src="<?php echo e(asset('/assets/images/car-online.png')); ?>" class="object-fit-cover"
                ...
                <div class="col-6 col-lg-6">
                    <div class="d-flex flex-column gap-2 p-3 rounded" style="background:#F4F4F4">
                        <div>
                            <img src="<?php echo e(asset('/assets/images/wait-confirm.png')); ?>" class="object-fit-cover"
                                style="height: 30px" alt="">
                        </div>
                ...
                <div class="col-6 col-lg-6">
                    <div class="d-flex flex-column gap-2 p-3 rounded" style="background:#F4F4F4">
                        <div>
                            <img src="<?php echo e(asset('/assets/images/completed-ic.png')); ?>" class="object-fit-cover"
                                style="height: 30px" alt="">
                        </div>
                ...
                <div class="col-6 col-lg-6">
                    <div class="d-flex flex-column gap-2 p-3 rounded" style="background:#F4F4F4">
                        <div>
                            <img src="<?php echo e(asset('/assets/images/cancel-ic.png')); ?>" class="object-fit-cover"
                                style="height: 30px" alt="">
                        </div>
        ...
        <div class="mt-4 mb-5">
            ...
            <div class="row g-3">
                <div class="col-6 col-lg-6">
                    <div class="d-flex flex-column gap-2 p-3 rounded" style="background:#F4F4F4">
                        <div>
                            <img src="<?php echo e(asset('/assets/images/car-parking-ic.png')); ?>" class="object-fit-cover"
                                style="height: 30px" alt="">
                        </div>
                ...
                <div class="col-6 col-lg-6">
                    <div class="d-flex flex-column gap-2 p-3 rounded" style="background:#F4F4F4">
                        <div>
                            <img src="<?php echo e(asset('/assets/images/have-drive.png')); ?>" class="object-fit-cover"
                                style="height: 30px" alt="">
                        </div>
...
<?php echo $__env->make('layouts.layout-with-sidebar-owner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\otod\resources\views/dashboard-owner.blade.php ENDPATH**/ ?>