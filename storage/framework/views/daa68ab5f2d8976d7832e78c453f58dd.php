                    ...
                    <div class="result-card border rounded-4 p-3 mb-3"
                        ...
                        <div class="d-flex align-items-start justify-content-between">
                            ...
                            <div class="d-flex gap-3">
                                <img src="<?php echo e(asset('/assets/images/prepare-2.png')); ?>" alt="Kia Rio" class="rounded-3"
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="<?php echo e(asset('/assets/images/tram-ic.png')); ?>" alt="Kia Rio">
                                                <span class="text-muted small">Trạm KM 133+770</span>
                                            </div>
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="<?php echo e(asset('/assets/images/calendar-ic2.png')); ?>" alt="Kia Rio">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\otod\resources\views/search-result-car.blade.php ENDPATH**/ ?>