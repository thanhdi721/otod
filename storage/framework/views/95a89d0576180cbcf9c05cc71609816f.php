                    ...
                    <div class="car-item mt-4 d-flex flex-column gap-3 border p-3 rounded-4">
                        ...
                        <?php if($car['status'] === 'renting'): ?>
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="<?php echo e(route('update-schedule-car')); ?>"
...
<?php echo $__env->make('layouts.layout-with-sidebar-owner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Source Web\otod-github\otod\resources\views/car-list.blade.php ENDPATH**/ ?>