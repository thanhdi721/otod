...
<?php $__env->startSection('title', 'Chụp hình ngoài xe - OTOD'); ?>
    ...
    <div class="container">
        ...
        <div class="mt-5 mb-4">
            <div class="d-flex align-items-center mb-3">
                <a href="<?php echo e(route('car-prepare')); ?>" class="btn btn-back me-3">
                    ...
                    <div class="photo-contai">
                        <div class="photo-card" onclick="uploadPhoto(1)">
                            ...
                            <div class="car-outline front-view">
                                <img src="<?php echo e(asset('/assets/images/car-ex-1.png')); ?>" alt="">
                            </div>
                    ...
                    <div class="photo-contai">
                        <div class="photo-card" onclick="uploadPhoto(2)">
                            ...
                            <div class="car-outline front-angled">
                                <img src="<?php echo e(asset('/assets/images/car-ex-2.png')); ?>" alt="">
                            </div>
                            <div class="upload-section">
                                <i class="bi bi-camera"></i>
                                <span>Tải ảnh</span>
                ...
                <div class="col-6 col-md-3" id="preview-3">
                    <div class="photo-contai">
                        <div class="photo-card" onclick="uploadPhoto(3)">
                            ...
                            <div class="car-outline front-view">
                                <img src="<?php echo e(asset('/assets/images/car-ex-3.png')); ?>" alt="">
                            </div>
                            <div class="upload-section">
                                <i class="bi bi-camera"></i>
                                <span>Tải ảnh</span>
                    ...
                    <div class="photo-contai">
                        <div class="photo-card" onclick="uploadPhoto(4)">
                            ...
                            <div class="car-outline front-right">
                                <img src="<?php echo e(asset('/assets/images/car-ex-4.png')); ?>" alt="">
                            </div>
                            <div class="upload-section">
                                <i class="bi bi-camera"></i>
                                <span>Tải ảnh</span>
                    ...
                    <div class="photo-contai">
                        <div class="photo-card" onclick="uploadPhoto(5)">
                            ...
                            <div class="car-outline rear-left">
                                <img src="<?php echo e(asset('/assets/images/car-ex-5.png')); ?>" alt="">
                            </div>
                            <div class="upload-section">
                                <i class="bi bi-camera"></i>
                                <span>Tải ảnh</span>
                    ...
                    <div class="photo-contai">
                        <div class="photo-card" onclick="uploadPhoto(6)">
                            ...
                            <div class="car-outline rear-right">
                                <img src="<?php echo e(asset('/assets/images/car-ex-6.png')); ?>" alt="">
                            </div>
                            <div class="upload-section">
                                <span>Tải ảnh</span>
                            </div>
                    ...
                    <div class="photo-contai">
                        <div class="photo-card" onclick="uploadPhoto(7)">
                            ...
                            <div class="car-outline rear-view">
                                <img src="<?php echo e(asset('/assets/images/car-ex-7.png')); ?>" alt="">
                            </div>
                            <div class="upload-section">
                                <i class="bi bi-camera"></i>
                                <span>Tải ảnh</span>
        ...
        <div class="text-center text-lg-start">
            <a href="<?php echo e(route('car-confirm-return')); ?>" class="btn btn-continue btn-lg px-5 py-3">
                Tiếp tục
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Source Web\otod-github\otod\resources\views/car-exterior-photos-return.blade.php ENDPATH**/ ?>