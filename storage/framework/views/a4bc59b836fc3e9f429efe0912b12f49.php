    ...
    <div class="container w-100 mt-4" style="max-width: 800px">
        ...
        <div class="position-relative">
            <div class="banner-container">
                <img class="w-100" src="<?php echo e(asset('/assets/images/banner-detail.png')); ?>" alt="Station Banner"
                    style=" object-fit: cover;">
            </div>

            <!-- Profile Picture Overlay - Separate Container -->
            <div class="profile-picture-overlay">
                <img src="<?php echo e(asset('/assets/images/avatar-2.png')); ?>" alt="Profile" style="border: 4px solid white;">
            </div>
        </div>
        ...
        <div class="container mt-4">
            <div class="provider-info">
                ...
                <div class="d-flex justify-content-between gap-3 mb-4">
                    <?php for($i = 0; $i < 4; $i++): ?>
                        <div class="flex-fill">
                            <img src="<?php echo e(asset('/assets/images/car-station.png')); ?>" alt="Kia Rio"
                            ...
                            <div class="d-flex">
                                ...
                                <div class="position-relative" style=" flex-shrink: 0;">
                                    ...
                                    <div class="position-absolute top-0 end-0 m-2">
                                        <img src="<?php echo e(asset('/assets/images/heart-ic.png')); ?>" alt="">
                                    </div>
                                </div>
                                <!-- Car Details -->
                                    ...
                                    <div>
                                        ...
                                        <div class="row car-spe g-2 mb-3">
                                            <div class="col-md-6 col-6">
                                                <img src="<?php echo e(asset('/assets/images/icon-transmission.png')); ?>"
                                                    alt="" style="width: 20px;">
                                                <span class="small">Số tự động</span>
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <img src="<?php echo e(asset('/assets/images/icon-seat.png')); ?>" alt=""
                                                    style="width: 20px;">
                                                <span class="small">4 chỗ</span>
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <img src="<?php echo e(asset('/assets/images/icon-fuel.png')); ?>" alt=""
                                                    style="width: 20px;">
                                                <span class="small">Xăng</span>
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <img src="<?php echo e(asset('/assets/images/icon-consumption.png')); ?>" alt=""
                                                    style="width: 20px;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\otod\resources\views/station.blade.php ENDPATH**/ ?>