...
<?php $__env->startSection('content'); ?>
    <div class="container w-100 mt-4" style="max-width: 605px">
        ...
        <div class="d-flex justify-content-center gap-3">
            <button type="button" class="btn-back px-4" onclick="showDeleteModal()"
                style="background-color: transparent; color: #DC2626; border-radius: 8px; border: 1px solid #DC2626; padding: 10px 20px;">Xóa
                xe</button>
            <button type="button" id="confirmAddCar" class="btn-continue px-4"
                style="background-color: #2B4896; color: #fff; border-radius: 8px; border: none; padding: 10px 20px;">Chỉnh
                sửa</button>
        </div>
    </div>
    ...
    <div id="deleteModal" class="modal-overlay" style="display: none;">
        <div class="modal-content bg-white rounded">
            ...
            <p class="modal-text">Bạn có chắc chắn muốn xoá xe này trên OTOD?</p>
            <button type="button" class="btn-delete" onclick="confirmDelete()">Xoá</button>
        </div>
    </div>
...
<script>
    ...
    function confirmDelete() {
        ...
        try {
            sessionStorage.setItem('carDeletedSuccess', '1');
        } catch (e) {}

        // Redirect về trang car-list
        window.location.href = "<?php echo e(route('car-list')); ?>";
    }
...
<?php echo $__env->make('layouts.layout-with-sidebar-owner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\otod\resources\views/update-schedule-car.blade.php ENDPATH**/ ?>