...
<?php $__env->startSection('title', 'Article Detail - OTOD'); ?>
...
<div class="container py-5">
  <div class="row justify-content-center">
     <img src="<?php echo e(asset('/assets/images/banner-page-detail.png')); ?>" alt="<?php echo e($article['title'] ?? 'Article Image'); ?>" class="detail-image">
    <div class="col-lg-8">
      
      
     
      
      <h1 class="detail-title"><?php echo e($article['title'] ?? 'Experience the Serenity of Japan\'s Traditional Countryside'); ?></h1>
      
      <div class="detail-date">
        <i class="fas fa-calendar"></i>
        <span><?php echo e($article['date'] ?? '12/04/2024'); ?></span>
      </div>
...
?>
      ...
      <div class="mt-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <a href="<?php echo e(route('content.discover')); ?>" class="text-primary text-decoration-none">Xem thêm</a>
        </div>

        <!-- Desktop/tablet grid -->
        <div class="row g-4 d-none d-md-flex">
          <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-4 col-sm-6">
              <a href="<?php echo e(route('content.detail', ['id' => $i, 'section' => 'noi-bat', 'title' => urlencode($item['title']), 'date' => $item['date']])); ?>" class="text-decoration-none">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Source Web\otod-github\otod\resources\views/content-detail.blade.php ENDPATH**/ ?>