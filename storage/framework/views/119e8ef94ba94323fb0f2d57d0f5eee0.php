<?php $__env->startSection('title', 'Carzip - Gần kiểm soát, an toàn'); ?>
    ...
    <div class="container mt-4">
        ...
        <div class="hero-section ">
            <div class="hero-background position-relative ">
                <img src="<?php echo e(asset('/assets/images/carzip-banner.png')); ?>" alt="Car Interior"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="feature-item card shadow-sm p-3 mb-4">
                            <div class="feature-icon d-inline-flex align-items-center justify-content-center me-3">
                                <img src="<?php echo e(asset('/assets/images/ic-carzip1.png')); ?>" alt="GPS">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="feature-item featur-item-2 card shadow-sm p-3 mb-4">
                            <div class="feature-icon d-inline-flex align-items-center justify-content-center me-3">
                                <img src="<?php echo e(asset('/assets/images/ic-carzip8.png')); ?>" alt="Dashboard">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-item card shadow-sm p-3 mb-4">
                            <div class="feature-icon d-inline-flex align-items-center justify-content-center me-3">
                                <img src="<?php echo e(asset('/assets/images/ic-carzip2.png')); ?>" alt="Remote">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-item featur-item-2 card shadow-sm p-3 mb-4">
                            <div class="feature-icon d-inline-flex align-items-center justify-content-center me-3">
                                <img src="<?php echo e(asset('/assets/images/ic-carzip3.png')); ?>" alt="Warning">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-item  card shadow-sm p-3 mb-4">
                            <div class="feature-icon d-inline-flex align-items-center justify-content-center me-3">
                                <img src="<?php echo e(asset('/assets/images/ic-carzip7.png')); ?>" alt="Phone">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-item featur-item-2 card shadow-sm p-3 mb-4">
                            <div class="feature-icon d-inline-flex align-items-center justify-content-center me-3">
                                <img src="<?php echo e(asset('/assets/images/ic-carzip4.png')); ?>" alt="Speedometer">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-item card shadow-sm p-3 mb-4">
                            <div class="feature-icon d-inline-flex align-items-center justify-content-center me-3">
                                <img src="<?php echo e(asset('/assets/images/ic-carzip6.png')); ?>" alt="Network">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-item  featur-item-2 card shadow-sm p-3 mb-4">
                            <div class="feature-icon d-inline-flex align-items-center justify-content-center me-3">
                                <img src="<?php echo e(asset('/assets/images/ic-carzip5.png')); ?>" alt="Battery">
                            </div>
                            <div class="feature-content">
                    ...
                    <div class="col-lg-6 col-12" style="padding-top: 20px; padding-bottom: 20px; padding-left: 60px;">
                        <div class="promo-content">
                            <div class="d-flex flex-column mb-3">
                                <img class="mb-2" src="<?php echo e(asset('/assets/images/logo-white.png')); ?>" alt="OTOD"
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="promo-image position-absolute">
                            <div class="promo-image-content position-relative">
                                <img src="<?php echo e(asset('/assets/images/posster-carzip1.png')); ?>" alt="Promotional Person"
                                    class="img-fluid img-person rounded position-absolute">
                                <img src="<?php echo e(asset('/assets/images/ellipse-2.png')); ?>" alt="Promotional Person"
                                    class="img-fluid img-ellipse-2 rounded position-absolute">
                                <img src="<?php echo e(asset('/assets/images/ellipse-3.png')); ?>" alt="Promotional Person"
                                    class="img-fluid img-ellipse-3 d-block d-lg-none rounded position-absolute">
                                <img src="<?php echo e(asset('/assets/images/ellipse-1.png')); ?>" alt="Promotional Person"
                            ...
                            <div class="d-flex align-items-baseline justify-content-between mb-3 w-100">
                                <div class="d-flex align-items-baseline justify-content-start gap-2 w-100">
                                    <div class="d-flex align-items-center my-auto justify-content-center">
                                        <img src="<?php echo e(asset('/assets/images/avatar-2.png')); ?>" alt="Nguyễn Văn Tuấn"
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="review-card p-4">
                            <div class="d-flex align-items-baseline justify-content-between mb-3 w-100">
                                <div class="d-flex align-items-baseline justify-content-start gap-2 w-100">
                                    <div class="d-flex align-items-center my-auto justify-content-center">
                                        <img src="<?php echo e(asset('/assets/images/avatar-2.png')); ?>" alt="Trần Thị Mai"
                                            class="rounded-circle" style="width: 40px; height: 40px;">
                                    </div>
                                    <div class="d-flex flex-column align-items-start w-100">
                                        <div
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="review-card p-4">
                            <div class="d-flex flex-column align-items-start gap-2 mb-3">
                                <div class="d-flex align-items-baseline justify-content-start gap-2 w-100">
                                    <div class="d-flex align-items-center my-auto justify-content-center">
                                        <img src="<?php echo e(asset('/assets/images/avatar-2.png')); ?>" alt="Lê Văn Hùng"
                                            class="rounded-circle" style="width: 40px; height: 40px;">
                                    </div>
                                    <div class=" d-flex flex-column align-items-start w-100">
                                        <div
            ...
            <div class="container">
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-3 col-md-6 text-center mb-4">
                        <img src="<?php echo e(asset('/assets/images/logo-cz1.png')); ?>" alt="Partner 1" class="partner-logo">
                    </div>
                    <div class="col-lg-3 col-md-6 text-center mb-4">
                        <img src="<?php echo e(asset('/assets/images/logo-cz2.png')); ?>" alt="Partner 2" class="partner-logo">
                    </div>
                    <div class="col-lg-3 col-md-6 text-center mb-4">
                        <img src="<?php echo e(asset('/assets/images/logo-cz3.png')); ?>" alt="Partner 3" class="partner-logo">
                    </div>
                    <div class="col-lg-3 col-md-6 text-center mb-4">
                        <img src="<?php echo e(asset('/assets/images/logo-cz4.png')); ?>" alt="Partner 4" class="partner-logo">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\otod\resources\views/car-zip.blade.php ENDPATH**/ ?>