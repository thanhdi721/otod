...
<?php $__env->startSection('content'); ?>
    ...
    <head>
        ...
        <style>
            ...
            /* Hide scrollbar for story images */
            .story-images-section .d-flex::-webkit-scrollbar {
                display: none;
            }
            ...
            #reviewModal .btn-primary:disabled {
                opacity: 0.6;
                cursor: not-allowed;
            }
    ...
    <body>
        ...
        <div>
            <div class="container py-3">
                <a href="#" class="text-decoration-none text-dark d-flex align-items-center" onclick="history.back()">
                    <div
                        class="text-dark p-3 bg-white border border-2 border-gray rounded-circle w-16 h-16 d-flex align-items-center justify-content-center">
        ...
        <div class="container py-4">
            ...
            <!-- Status Banner -->
            <?php if(request()->get('status') == 'completed'): ?>
                <div class="status-banner mb-4"
                    style="background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; padding: 1rem;">
                    <div class="d-flex align-items-center">
                        <i class="bi bi-check-circle-fill text-success me-2" style="font-size: 1.2rem;"></i>
                        <span class="fw-semibold text-dark">Chuyến đi đã hoàn thành</span>
                    </div>
                </div>
            <?php elseif(request()->get('status') == 'rejected'): ?>
                <div class="status-banner mb-4"
                    style="background: #fff5f5; border: 1px solid #fed7d7; border-radius: 8px; padding: 1rem;">
                    <div class="d-flex align-items-center">
                        <i class="bi bi-x-circle-fill text-danger me-2" style="font-size: 1.2rem;"></i>
                        <span class="fw-semibold text-danger">Chủ xe đã từ chối</span>
                    </div>
                </div>
            <?php elseif(request()->get('status') == 'pending_review'): ?>
                <div class="status-banner mb-4"
                    style="background: #fffbf0; border: 1px solid #fbd38d; border-radius: 8px; padding: 1rem;">
                    <div class="d-flex align-items-center">
                        <i class="bi bi-clock-fill text-warning me-2" style="font-size: 1.2rem;"></i>
                        <span class="fw-semibold text-warning">Đang chờ đánh giá từ bạn</span>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <!-- Story Images Section (only show for pending_review status) -->
                    <?php if(request()->get('status') == 'pending_review'): ?>
                        <div class="story-images-section mb-4">
                            <div class="d-flex gap-3 overflow-auto"
                                style="scrollbar-width: none; -ms-overflow-style: none;">
                                <div class="story-image-container flex-shrink-0">
                                    <div class="story-image position-relative">
                                        <img src="<?php echo e(asset('assets/images/str.jpg')); ?>" alt="Car Story 1"
                                            class="rounded-3 story-main-image">
                                        <div class="story-overlay rounded-3"></div>
                                        <div class="story-profile-image">
                                            <img src="<?php echo e(asset('assets/images/str.jpg')); ?>" alt="Profile"
                                                class="rounded-circle">
                                        </div>
                                    </div>
                                    <p class="text-center mt-2 mb-0 small fw-semibold">Tuấn Trần</p>
                                </div>
                                <div class="story-image-container flex-shrink-0">
                                    <div class="story-image position-relative">
                                        <img src="<?php echo e(asset('assets/images/str.jpg')); ?>" alt="Car Story 2"
                                            class="rounded-3 story-main-image">
                                        <div class="story-overlay rounded-3"></div>
                                        <div class="story-profile-image">
                                            <img src="<?php echo e(asset('assets/images/str.jpg')); ?>" alt="Profile"
                                ...
                                <div class="story-image-container flex-shrink-0">
                                    <div class="story-image position-relative">
                                        <img src="<?php echo e(asset('assets/images/str.jpg')); ?>" alt="Car Story 3"
                                            class="rounded-3 story-main-image">
                                        <div class="story-overlay rounded-3"></div>
                                        <div class="story-profile-image">
                                            <img src="<?php echo e(asset('assets/images/str.jpg')); ?>" alt="Profile"
                                ...
                                <div class="story-image-container flex-shrink-0">
                                    <div class="story-image position-relative">
                                        <img src="<?php echo e(asset('assets/images/str.jpg')); ?>" alt="Car Story 4"
                                            class="rounded-3 story-main-image">
                                        <div class="story-overlay rounded-3"></div>
                                        <div class="story-profile-image">
                                            <img src="<?php echo e(asset('assets/images/str.jpg')); ?>" alt="Profile"
                    ...
                    <!-- Đánh giá -->
                    <div class="d-flex align-items-center mt-2 border-gray border rounded-pill p-2"
                        style="width: fit-content;">
                        <span class="badge text-dark me-2 fs-6 "
                            style="border-right: 1px solid #e0e0e0; padding-right: 10px;">
                            4.0 <img src="<?php echo e(asset('assets/images/ic-star.png')); ?>" alt="star"
                                class="img-fluid mb-1" style="width: 10px; height: 10px;">
                        </span>
                        <a href="#" class="text-decoration-none fs-6" style="color: #2B4896; font-weight: 500;">325
                            đánh giá</a>
                    </div>

                    <!-- Địa chỉ -->
                    <div class="text-muted mt-1 d-flex align-items-center" style="font-weight: 500;">
                        <img src="<?php echo e(asset('assets/images/ic-location.png')); ?>" alt="location"
                            class="img-fluid mb-1 me-1" style="width: 16px; height: 16px;"> Quận 1, TP Hồ Chí Minh
                    </div>
                    ...
                    <p style="cursor: pointer;" class="text-primary fw-semibold text-decoration-none"
                        onclick="openInsuranceModal()">Xem chi tiết</p>
                    <hr>
                    <div class="">
                        ...
                        <div class="row text-center mb-4">
                            <div class="col-6 col-md-3">
                                <img src="<?php echo e(asset('assets/images/dd1.png')); ?>" alt="gear" class="img-fluid mb-1"
                                    style="width: 32px; height: 32px;">
                                <p class="mb-0 text-muted">Truyền động</p>
                                <p class="fw-semibold">Số sàn</p>
                            </div>
                            <div class="col-6 col-md-3">
                                <img src="<?php echo e(asset('assets/images/dd2.png')); ?>" alt="gear" class="img-fluid mb-1"
                                    style="width: 32px; height: 32px;">
                                <p class="mb-0 text-muted">Số ghế</p>
                                <p class="fw-semibold">4 chỗ</p>
                            </div>
                            <div class="col-6 col-md-3">
                                <img src="<?php echo e(asset('assets/images/dd3.png')); ?>" alt="gear" class="img-fluid mb-1"
                                    style="width: 32px; height: 32px;">
                                <p class="mb-0 text-muted">Nhiên liệu</p>
                                <p class="fw-semibold">Xăng</p>
                            </div>
                            <div class="col-6 col-md-3">
                                <img src="<?php echo e(asset('assets/images/dd4.png')); ?>" alt="gear" class="img-fluid mb-1"
                                    style="width: 32px; height: 32px;">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mb-3 position-relative">
                            <img src="<?php echo e(asset('assets/images/banner-detail.png')); ?>" class="w-100 rounded"
                                alt="banner">
                            <div class="position-absolute top-100 start-50 translate-middle">
                                <img src="<?php echo e(asset('assets/images/avatar.png')); ?>"
                                    class="rounded-circle border border-3 border-white" alt="avatar">
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-5">
                            ...
                            <span class="text-muted small">Trạm xe đối tác xác thực</span><span
                                class="ms-2 p-1 rounded-pill bg-warning text-dark fw-semibold">39 chuyến xe</span>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-1 small">
                                                Mình vừa thuê xe từ lái ở đây cuối tuần rồi, phải nói là cực kỳ hài lòng. Xe
                                                mới, sạch sẽ, máy móc chạy êm ru.
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="col-md-6">
                                    ...
                                    <div class="rounded-3" style="background: #F4F4F4;">
                                        ...
                                        <div class="p-2">
                                            <div>
                                                ...
                                                <div class="fw-bold d-flex justify-content-between">
                                                    <div>21:00 T4, 09/04/2025</div>
                                                    <div><i class="bi bi-chevron-down text-muted"></i></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="p-2">
                                            <div>
                                                ...
                                                <div class="fw-bold d-flex justify-content-between">
                                                    <p>21:00 T6, 11/04/2025</p> <i
                                                        class="bi bi-chevron-down text-muted"></i>
                                                </div>
                                            </div>
                        ...
                        <label class="pickup-option d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <div class="fw-semibold"> <i class="bi bi-geo-alt me-2 text-muted"></i>Bấm để chọn
                                    </div>
                    ...
                    <div class="container my-4">
                        ...
                        <div class=" p-3 rounded shadow-sm" style="background: #F4F4F4;">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                <span style="cursor: pointer;" onclick="openOtodFeeModal()">Phí OTOD <i
                            ...
                            <div class="border border-success rounded p-2 mb-3 d-flex justify-content-between align-items-center text-success fw-semibold"
                                style="background:#f0fdf4; cursor:pointer;" onclick="openPromotionModal()">
                                <span><img src="<?php echo e(asset('assets/images/elements.png')); ?>" alt="gift"
                                        class="img-fluid me-2" style="width: 20px; height: 20px;"> Mã khuyến mại</span>
                    ...
                    <div>
                        ...
                        <table class="table table-bordered align-middle text-center">
                            <thead>
                                <tr>
                                    <th style="background-color: #2B4896; color: #fff; text-align:start;">Thời điểm hủy
                                        chuyến</th>
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-muted small">
                                ...
                                "Yêu cầu hủy chuyến" trên web/app của OTOD. Việc hủy chuyến cần được thực hiện sớm nhất có
                                thể,
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-primary fw-semibold text-decoration-none" style="cursor: pointer;"
                                onclick="openRegulationsModal()">Xem các quy định khác &gt;</p>
                        </div>
            ...
            <div class="container my-4">
                <div class="d-flex justify-content-between align-items-center bg-white shadow-sm rounded p-3">
                    ...
                    <div>
                        ...
                        <h5 class="mb-0 fw-bold fs-6 fs-md-5 fs-lg-4">2.089.710đ <span
                                class="fw-normal text-muted fs-6 fs-md-5 fs-lg-4">- 3
                                ngày 4 giờ</span></h5>
                    </div>

                    <!-- Action Buttons -->
                    <?php if(request()->get('status') == 'pending_review'): ?>
                        <!-- Two buttons for pending review status -->
                        <div class="d-block d-lg-flex gap-2">
                            <button class="btn px-4 rounded fw-semibold mb-2 mb-lg-0"
                                style="background: #F4F4F4; color: #999999; border: none;"
                                onclick="openReviewModal()">Đánh giá</button>
                            <button class="btn px-4 rounded fw-semibold"
                                style="background: #2B4896; color: #fff; border: none;" onclick="navigateToPayment()">Trả
                                xe</button>
                        </div>
                    <?php elseif(request()->get('status') == 'rejected'): ?>
                        <!-- Button for rejected status -->
                        <button class="btn px-4 rounded fw-semibold"
                            style="background: #2B4896; color: #fff; border: none;" onclick="navigateToPayment()">Thuê xe
                            khác</button>
                    <?php else: ?>
                        <!-- Single button for other statuses (completed, default) -->
                        <button class="btn px-4 rounded" style="background: #2B4896; color: #fff;"
                            onclick="navigateToPayment()">Thuê xe</button>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th style="background-color: #2B4896; color: white; text-align:center !important;"
                                            class="text-center">Yếu tố bảo hiểm</th>
                                        <th style="background-color: #2B4896; color: white;" class="text-center">Sẵn sàng
                                            chấp nhận rủi ro</th>
                                        <th style="background-color: #2B4896; color: white;" class="text-center">Tôi muốn
                                            bảo vệ bản thân mình</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="text-start">Thiệt hại do va chạm của xe cho thuê</td>
                                        <td class="text-center"><i class="bi bi-check-circle-fill text-success fs-5"></i>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-start">
                                            <a href="#" class="text-primary text-decoration-none">Điều khoản và điều
                                                kiện</a>
                                        </td>
                        ...
                        <div class="promotion-list"
                            ...
                            <div class="promotion-item d-flex align-items-center p-3 border rounded mb-3">
                                <div class="ticket-icon me-1">
                                    <img src="<?php echo e(asset('assets/images/voucher.png')); ?>" alt="gift"
        ...
        <!-- Regulations Modal -->
        <div class="modal fade" id="regulationsModal" tabindex="-1" aria-labelledby="regulationsModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="regulations-list">
                            ...
                            <!-- Regulation 7 -->
                            <div class="regulation-item pb-1 mb-1 border-bottom">
                                <p class="text-muted mb-0">Khi trả xe, nếu xe Vết thương hoặc có mùi trong xe, khách hàng
                                    vui lòng bảo vệ xe sạch sẽ hoặc gửi phụ thu phí bảo vệ xe</p>
                            </div>

                            <!-- Regulation 8 -->
                            <div class="regulation-item pb-1 mb-1 border-bottom">
                                <p class="text-muted mb-0">Xe được giới hạn di chuyển ở mức 300km cho 24h, và các lần như
                                    150km, 200km, 250 km cho gói 4h, 8h, 12h</p>
                            </div>

                            <!-- Regulation 9 -->
                            <div class="regulation-item pb-1 mb-1">
                                <p class="text-muted mb-0">Phí quá giờ áp dụng là 150.000 đồng cho gói 24h, và 400.000 đồng
                                    cho gói 4h, 350.000 đồng cho gói 8h, 200.000 đồng cho gói 12h</p>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-primary px-5 py-2 fw-semibold"
                            style="background: #2B4896; border: none;">Đồng ý</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- OTOD Fee Modal -->
        <div class="modal fade" id="otodFeeModal" tabindex="-1" aria-labelledby="otodFeeModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="service-list">
                            ...
                            <!-- Service 2 -->
                            <div class="service-item mb-3">
                                <p class="text-muted mb-0">Tìm xe thay thế / hoàn tiền / đền tiền nếu chuyến bị hủy bởi chủ
                                    xe</p>
                            </div>
                            ...
                            <!-- Service 5 -->
                            <div class="service-item mb-3">
                                <p class="text-muted mb-0">Hỗ trợ làm việc với nhà bảo hiểm, garage đối tác khi xảy ra sự
                                    cố (nếu có).</p>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn px-5 py-2 fw-semibold rounded"
                            style="background: #FFD700; color: #000; border: none;">Đóng</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="reviewModal" tabindex="-1" aria-labelledby="reviewModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fw-bold" id="reviewModalLabel">Đánh giá chuyến đi</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="text-center mb-4">
                            <div class="rating-stars mb-2">
                                <i class="bi bi-star fs-3 me-2 rating-star" data-rating="1"
                                    style="color: #ddd; cursor: pointer;"></i>
                                <i class="bi bi-star fs-3 me-2 rating-star" data-rating="2"
                                    style="color: #ddd; cursor: pointer;"></i>
                                <i class="bi bi-star fs-3 me-2 rating-star" data-rating="3"
                                    style="color: #ddd; cursor: pointer;"></i>
                                <i class="bi bi-star fs-3 me-2 rating-star" data-rating="4"
                                    style="color: #ddd; cursor: pointer;"></i>
                                <i class="bi bi-star fs-3 rating-star" data-rating="5"
                                    style="color: #ddd; cursor: pointer;"></i>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <textarea class="form-control" id="reviewText" rows="4"
                                placeholder="Hãy nhập cảm nhận về chuyến đi của bạn nhé!"
                                style="border: 1px solid #e0e0e0; border-radius: 8px; resize: none;"></textarea>
                        </div>

                        <!-- Media Upload -->
                        <div class="row mb-4">
                            <div class="col-6">
                                <div class="upload-card text-center p-3 border-2 border-dashed rounded-3"
                                    style="border-color: #e0e0e0; cursor: pointer;"
                                    onclick="document.getElementById('photoUpload').click();">
                                    <i class="bi bi-camera fs-4 text-muted mb-2"></i>
                                    <p class="text-muted mb-0 small">Ảnh</p>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary px-4 py-2 fw-semibold"
                            style="background: #2B4896; border: none; width: 100%;" onclick="submitReview()">
                            Gửi đánh giá
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content text-center">
                    <div class="modal-body py-4">
                        ...
                        <h6 class="fw-bold mb-3">Cám ơn bạn đã sử dụng dịch vụ của OTOD</h6>
                        <button type="button" class="btn btn-primary px-4 py-2 fw-semibold"
                            style="background: #2B4896; border: none;" onclick="goToHomepage()">
                            Về trang chủ
                        </button>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\otod\resources\views/car-detail.blade.php ENDPATH**/ ?>