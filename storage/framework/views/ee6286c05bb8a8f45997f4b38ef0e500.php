...
<?php $__env->startSection('title', 'Maps Demo - OTOD Web Layout UI'); ?>

<?php $__env->startSection('styles'); ?>
<link rel="stylesheet" href="<?php echo e(asset('libs/leaflet1.4.0/leaflet.css')); ?>" />
<style>
    #map {
        height: 400px;
        width: 100%;
...
<script src="<?php echo e(asset('libs/leaflet1.4.0/leaflet.js')); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Source Web\otod-github\resources\views/demo/maps.blade.php ENDPATH**/ ?>