    ...
    <div class="container">
        ...
        <div class="mt-5 mb-4">
            <div class="d-flex align-items-center mb-3">
                <a href="<?php echo e(route('car-prepare-owner')); ?>" class="btn btn-back me-3">
        ...
        <div class="text-center text-lg-start">
            <a href="<?php echo e(route('car-confirm-prepare-owner')); ?>" class="btn btn-continue btn-lg px-5 py-3">
                Tiếp tục
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\otod\resources\views/car-exterior-photos-prepare-owner.blade.php ENDPATH**/ ?>