...
<?php $__env->startSection('title', 'Chuẩn bị xe cho thuê - OTOD'); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                ...
                <div class="preparation-steps mb-5">
                    ...
                    <a href="<?php echo e(route('car-exterior-photos-prepare-owner')); ?>" style="text-decoration: none">
                        <div class="step-item mb-3">
                            <div class="step-content">
                                <div class="step-left">
                                    <div class="step-icon">
                                        <img src="<?php echo e(asset('/assets/images/picture-ic.png')); ?>" alt="">
                                    </div>
                    ...
                    <!-- Step 4: Take photo of other scratches -->
                    <a href="<?php echo e(route('car-exterior-photos-prepare-owner')); ?>" style="text-decoration: none">
                        <div class="step-item mb-3">
                            <div class="step-content">
                                <div class="step-left">
                                    ...
                                    <span class="step-text">Chụp hình các vết xước khác</span>
                                </div>
                                <div class="step-arrow">
                                    <i class="bi bi-chevron-right"></i>
                                </div>
                ...
                <div class="text-center">
                    <button class="btn btn-confirm btn-lg px-5 py-3 w-100" style="max-width: 448px;">
                        Tiếp tục
                    </button>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\otod\resources\views/car-prepare-owner.blade.php ENDPATH**/ ?>