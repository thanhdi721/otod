...
<?php $__env->startSection('title', 'Hồ sơ cá nhân - OTOD'); ?>
                ...
                <div class="profile-meta">
                    <div class="meta-info">
                        <div class="meta-top">
                            ...
                            <img src="<?php echo e(asset('assets/images/ic-check.png')); ?>" alt="Verify" width="24" height="24">
                        </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="gender-options">
                        <div class="gender-pill active" data-gender="male"><img src="<?php echo e(asset('assets/images/ic-man.png')); ?>" alt="Male"> Nam</div>
                        <div class="gender-pill" data-gender="female"><img src="<?php echo e(asset('assets/images/ic-women.png')); ?>" alt="Female"> Nữ</div>
                        <div class="gender-pill" data-gender="other"><img src="<?php echo e(asset('assets/images/ic-lgbt.png')); ?>" alt="Other"> Khác</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-setting">
            ...
            <div class="social-item">
                <div class="d-flex align-items-center gap-2">
                   <img src="<?php echo e(asset('assets/images/ic-facebook.png')); ?>" alt="Facebook" width="32" height="32">
                    <span>Facebook</span>
                </div>
            ...
            <div class="social-item">
                <div class="d-flex align-items-center gap-2">
                    <img src="<?php echo e(asset('assets/images/ic-tiktok.png')); ?>" alt="Tiktok" width="32" height="32">
                    <span>Tiktok</span>
                </div>
                <div class="form-check form-switch m-0">
                    <input class="form-check-input" type="checkbox">
...
<?php echo $__env->make('layouts.layout-with-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Source Web\otod-github\otod\resources\views/profile.blade.php ENDPATH**/ ?>