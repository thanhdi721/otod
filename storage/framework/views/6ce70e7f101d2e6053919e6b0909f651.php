...
<?php $__env->startSection('title', 'Chat với OTOD AI'); ?>
    ...
    <div style="background:#F4F4F4;">
        <div class="container py-4 position-relative"  style="max-width:760px;">
            ...
            <div class="position-absolute d-none d-md-block" style="top:56px; right:24px;">
                   ...
                   <img src="<?php echo e(asset('/assets/images/AIchat.png')); ?>" alt="OTOD" style="width:48px;height:48px;">
                ...
                <div class="ai-chat">
                    ...
                    <div id="chatArea">
                        ...
                        <div class="d-flex align-items-start gap-2 mb-2">
                            <div class="bot-avatar"><img src="<?php echo e(asset('/assets/images/AIchat.png')); ?>" alt="OTOD" style="width:28px;height:28px;"/></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Source Web\otod-github\otod\resources\views/chat-bot.blade.php ENDPATH**/ ?>