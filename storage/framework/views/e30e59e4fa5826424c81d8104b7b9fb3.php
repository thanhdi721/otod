                    ...
                    <form id="registerForm" novalidate>
                        ...
                        <div class="d-flex align-items-center gap-2 mb-3">
                            ...
                            <label class="form-check-label" for="agree">
                                Tôi đã đọc và đồng ý với <a href="<?php echo e(route('clause')); ?>"
        ...
        (function() {
            ...
            function toggle(btn, input) {
                btn.addEventListener('click', function() {
                    ...
                    btn.querySelector('img').src = isPwd ? '<?php echo e(asset('/assets/images/view.png')); ?>' :
...
<?php echo $__env->make('layouts.layout-not-header-footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\otod\resources\views/Auth/register.blade.php ENDPATH**/ ?>