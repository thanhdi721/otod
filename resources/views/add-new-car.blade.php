...
@section('content')
    <div class="container w-100 mt-4" style="max-width: 800px">
        ...
        <div class="d-flex align-items-center mb-4">
            <a href="{{ route('car-list') }}" class="text-decoration-none me-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <button type="button" class="btn position-absolute border" id="timeButton"
                                        ...
                                        <img src="{{ asset('/assets/images/calendar-04.png') }}" alt="calendar">
                                    </button>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer selected">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-0.png') }}" alt="map">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-1.png') }}" alt="camera">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-2.png') }}" alt="camera">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-3.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-4.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-5.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-6.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-7.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-8.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-9.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-10.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-11.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-12.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-13.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-14.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="utility-item p-3 border rounded-3 cursor-pointer">
                                    <div class="d-flex flex-column gap-2">
                                        <div>
                                            <img src="{{ asset('/assets/images/icon-15.png') }}" alt="sensor">
                                        </div>
                            ...
                            <div class="photo-upload-item">
                                ...
                                <div class="photo-placeholder" onclick="triggerFileInput('front')">
                                    <div class="photo-content d-flex gap-1">
                                        <img src="{{ asset('/assets/images/camera-ic.png') }}" alt="camera"
                                            class="camera-icon">
                    ...
                    <div class="document-list">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-2 p-3"
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-2">
                                <img src="{{ asset('/assets/images/icon-16.png') }}" alt="piggy bank">
                            </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-2 p-3"
                            style="background:#F4F4F4">
                            <div class="d-flex align-items-center justify-content-between gap-2">
                                <img src="{{ asset('/assets/images/icon-17.png') }}" alt="document">
                            </div>
                            <div class="document-info">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-2 p-3"
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-2">
                                <div>
                                    <img src="{{ asset('/assets/images/icon-18.png') }}" alt="terms">
                                </div>
                                <div class="document-info">
                                    Điều khoản thuê xe
                                </div>
...
<script>
    ...
    function nextFromPrice() {
        window.location.href = '{{ route('check-settings') }}';
    }
    ...
    function handleImageUpload(inputId, file) {
        ...
        reader.onload = function(e) {
            ...
            editIcon.src = "{{ asset('/assets/images/fr-edit.png') }}";
            editIcon.alt = 'edit';
    ...
    function updateContinueButton() {
        ...
        if (uploadedPhotos >= requiredPhotos) {
            ...
            continueBtn.innerHTML = `
                <img src="{{ asset('/assets/images/fr-tick.png') }}" alt="tick" style="width: 20px; height: 20px; margin-right: 8px;">
                Hoàn thành
            `;
        } else {
    ...
    function updateDocumentButtons() {
        ...
        documentButtons.forEach(button => {
            if (uploadedPhotos >= requiredPhotos) {
                ...
                button.innerHTML =
                    `<img src="{{ asset('/assets/images/fr-tick.png') }}" alt="tick" style="width: 25px; height: 25px;">`;
    ...
    function addTimeSlot(type, label) {
        ...
        rm.src = "{{ asset('/assets/images/cancle-ic2.png') }}";
    ...
    function updateSetupButton(type) {
        ...
        if (isDone) {
            btn.innerHTML =
                `<img src="{{ asset('/assets/images/fr-tick.png') }}" alt="tick" style="width: 20px; height: 20px;">`;
