...
@section('title', 'Hồ sơ cá nhân - OTOD (App Layout)')
    ...
    <div class="container w-100 page-wrap" style="margin-left: auto; max-width: 800px">
        <div class="profile-header mt-3 mt-lg-4 mb-3">
            <div class="profile-left">
                ...
                <div>
                    <div class="name-line">
                        ...
                        <img src="{{ asset('assets/images/ic-check.png') }}" alt="Verify" width="20" height="20">
                    </div>
            ...
            <div class="metric-pills">
                ...
                <div class="metric-pill"><img src="{{ asset('/assets/images/ic-poin.png') }}" alt="coin"> 341 điểm</div>
            </div>
        </div>
