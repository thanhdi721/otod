                ...
                <div class="card border-0 shadow-sm p-3">
                    ...
                    <div
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-2">
                            <img src="{{ asset('/assets/images/stop-clock-ic.png') }}" alt="Avatar"
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <img src="{{ asset('/assets/images/car-station.png') }}" alt="Kia Rio" class="rounded"
            ...
            <div class="order-card mb-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-3">
                        ...
                        <!-- Car Details -->
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <img src="{{ asset('/assets/images/merc-car.png') }}" alt="Mercedes" class="rounded"
                                style="width: 46px; height: 46px; object-fit: cover;">
                            <div class="flex-grow-1">
                                <div class="d-flex gap-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <button class="btn btn-sm rounded-circle">
                                    <img src="{{ asset('/assets/images/phone-ic2.png') }}" alt="Avatar">
                                </button>
                                <button class="btn btn-sm rounded-circle">
                                    <img src="{{ asset('/assets/images/mail-ic.png') }}" alt="Avatar">
                                </button>
                            </div>
                        </div>
            ...
            <div class="order-card mb-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-3">
                        ...
                        <!-- Car Details -->
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <img src="{{ asset('/assets/images/merc-car.png') }}" alt="Mitsubishi" class="rounded"
                                style="width: 46px; height: 46px; object-fit: cover;">
                            <div class="flex-grow-1">
                ...
                <div class="card border-0 shadow-sm p-3">
                    <div class="card-body p-0">
                        <div class="p-3">
                            ...
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <img src="{{ asset('/assets/images/merc-car.png') }}" alt="Kia Rio" class="rounded"
                                    style="width: 46px; height: 46px; object-fit: cover;">
                                <div class="flex-grow-1">
                                    <div class="d-flex gap-3">
                                        <h6 class="fw-bold mb-1">Kia Rio 2015</h6>
