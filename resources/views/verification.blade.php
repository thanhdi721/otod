...
@section('title', 'Xác thực thông tin - OTOD')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    verifyBtn.addEventListener('click', function() {
        if (selectedDocument === 'gplx') {
            ...
            window.location.href = '{{ route("verification.gplx") }}';
        } else if (selectedDocument === 'cccd') {
            // Redirect to CCCD verification page
            window.location.href = '{{ route("verification.cccd") }}';
        } else if (selectedDocument === 'vneid') {
            // Redirect to VNeID verification page
            window.location.href = '{{ route("verification.vneid") }}';
        } else {
