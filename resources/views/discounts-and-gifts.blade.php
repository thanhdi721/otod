...
@section('title', 'Mã giảm giá và quà tặng - OTOD')
    ...
    <div class="container w-100" style="margin-left: auto; max-width: 800px">
        ...
        <div class="discount-section mb-5">
            <div class="section-header d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('discount-codes') }}" class="view-all-link">Xem tất cả <i class="bi bi-chevron-right"></i></a>
            </div>
                ...
                <div class="discount-slider">
                    ...
                    <div class="discount-card">
                        <div class="discount-card-content">
                           <img src="{{ asset('/assets/images/voucher-refer.png') }}" alt="Katinat Matcha Latte" width="90px" height="90px">
        ...
        <div class="gifts-section">
            <div class="section-header d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('gifts') }}" class="view-all-link">Xem tất cả <i class="bi bi-chevron-right"></i></a>
            </div>
            ...
            <div class="gifts-cards">
                ...
                <div class="gift-card mb-3">
                    <div class="gift-card-content">
                        <div class="gift-image">
                            <img src="{{ asset('/assets/images/voucher.png') }}" alt="Katinat Matcha Latte" class="gift-img">
                        </div>
                        <div class="gift-info">
                ...
                <div class="gift-card mb-3">
                    <div class="gift-card-content">
                        <div class="gift-image">
                            <img src="{{ asset('/assets/images/voucher-refer.png') }}" alt="Katinat Matcha Latte" class="gift-img">
                        </div>
                        <div class="gift-info">
                            <div class="gift-title">[Katinat] Thẻ quà tặng Matcha Latte 50.000đ</div>
                            <div class="gift-date-points">
