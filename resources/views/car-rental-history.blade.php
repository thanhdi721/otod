...
@section('title', 'Lịch sử thuê xe - OTOD')

@section('content')
    <!-- Notification -->
    @if (request()->get('notification') == 'car_received')
    ...
    @endif
    @if (request()->get('notification') == 'car_return')
        <div class="notification-box" id="notificationBox">
            <div class="notification-content">
                <div class="notification-title fw-bold">Thông báo</div>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="car-image me-4">
                                            <img src="{{ asset('/assets/images/history-car.png') }}" alt="Mercedes-Benz"
                                        ...
                                        <div class="car-info flex-grow-1">
                                            ...
                                            <div class="car-details">
                                                ...
                                                <div class="detail-item mb-1">
                                                    <img src="{{ asset('/assets/images/position.png') }}" alt="location"
                                                        class="me-2" style="width: 16px; height: 16px;">
                                                    <span class="text-muted">Quận 5</span>
                                                </div>
                                                <div class="detail-item">
                                                    <img src="{{ asset('/assets/images/user-history.png') }}" alt="user"
                                        ...
                                        <div class="action-button d-none d-lg-block">
                                            <a href="{{ route('car-prepare') }}" style="text-decoration: none"
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="car-info flex-grow-1">
                                            ...
                                            <div class="car-details">
                                                ...
                                                <div class="detail-item">
                                                    <img src="{{ asset('/assets/images/user-history.png') }}"
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-start">
                                    <!-- Car Image -->
                                    <div class="car-image me-4">
                                        <img src="{{ asset('/assets/images/prepare-2.png') }}" alt="Mercedes-Benz"
                                            class="rounded-3" style="width: 120px; height: 80px; object-fit: cover;">
                                    </div>
                                    ...
                                    <!-- Action Button -->
                                    <div class="action-button d-none d-lg-block">
                                        <a href="{{ route('car-return') }}" style="text-decoration: none"
                                            class="btn-primary-for-otod rounded fw-bold px-4 py-2">
                                            Trả xe
                                        </a>
                                    </div>
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <!-- Action Button -->
                                    <div class="action-button d-none d-lg-block">
                                        <a href="{{ route('car-detail') }}?status=completed"
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-start">
                                    <!-- Car Image -->
                                    <div class="car-image me-4">
                                        <img src="{{ asset('/assets/images/return-1.png') }}" alt="Mercedes-Benz"
                                            class="rounded-3" style="width: 120px; height: 80px; object-fit: cover;">
                                    </div>
                                    ...
                                    <!-- Action Button -->
                                    <div class="action-button d-none d-lg-block">
                                        <a href="{{ route('car-detail') }}?status=rejected" style="text-decoration: none"
                                            class="btn-primary-for-otod rounded fw-bold px-4 py-2">
                                            Thuê lại
                                        </a>
                                    </div>
                                ...
                                <div class="action-button d-block d-lg-none mt-3">
                                    <a href="{{ route('car-detail') }}?status=rejected"
                                        class="btn-primary-for-otod rounded fw-bold px-4 py-2 w-100"
                                        style="height:44px;text-decoration: none">
                                        Thuê lại
                                    </a>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="action-button d-none d-lg-flex gap-2">
                                        ...
                                        <a href="{{ route('car-detail') }}?status=pending_review"
                                            style="text-decoration: none"
                                            class="btn-primary-for-otod rounded fw-bold px-4 py-2">
                                            Thuê lại
                                        </a>
