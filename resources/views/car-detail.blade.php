    ...
    <body>
            ...
            <div class="container py-3">
                <a href="#" class="text-decoration-none text-dark d-flex align-items-center" onclick="history.back()">
                    <div
                        ...
                        <img src="{{ asset('assets/images/arrow-left.png') }}" alt="Quay về" class="img-fluid">
                    </div>
        ...
        <div class="container py-4">
            ...
            <div class="car-image-container mb-4">
                <img src="{{ asset('assets/images/img-car.png') }}" alt="Hyundai Elantra" class="car-image" id="carImage">
            ...
            @elseif(request()->get('status') == 'pending_review')
                <div class="status-banner mb-4"
                ...
                <div class="col-md-6">
                            ...
                            <div class="d-flex gap-3 overflow-auto"
                                ...
                                <div class="story-image-container flex-shrink-0">
                                    <div class="story-image position-relative">
                                        <img src="{{ asset('assets/images/str.jpg') }}" alt="Car Story 1"
                                            class="rounded-3 story-main-image">
                                        <div class="story-overlay rounded-3"></div>
                                        <div class="story-profile-image">
                                            <img src="{{ asset('assets/images/str.jpg') }}" alt="Profile"
                                ...
                                <div class="story-image-container flex-shrink-0">
                                    <div class="story-image position-relative">
                                        <img src="{{ asset('assets/images/str.jpg') }}" alt="Car Story 2"
                                            class="rounded-3 story-main-image">
                                        <div class="story-overlay rounded-3"></div>
                                        <div class="story-profile-image">
                                            <img src="{{ asset('assets/images/str.jpg') }}" alt="Profile"
                                ...
                                <div class="story-image-container flex-shrink-0">
                                    <div class="story-image position-relative">
                                        <img src="{{ asset('assets/images/str.jpg') }}" alt="Car Story 3"
                                            class="rounded-3 story-main-image">
                                        <div class="story-overlay rounded-3"></div>
                                        <div class="story-profile-image">
                                            <img src="{{ asset('assets/images/str.jpg') }}" alt="Profile"
                                ...
                                <div class="story-image-container flex-shrink-0">
                                    <div class="story-image position-relative">
                                        <img src="{{ asset('assets/images/str.jpg') }}" alt="Car Story 4"
                                            class="rounded-3 story-main-image">
                                        <div class="story-overlay rounded-3"></div>
                                        <div class="story-profile-image">
                                            <img src="{{ asset('assets/images/str.jpg') }}" alt="Profile"
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <h3 class="fw-bold mb-0">HUYNDAI ELANTRA 2022
                            <img src="{{ asset('assets/images/ic-check.png') }}" alt="check" class="img-fluid">
                        </h3>
                    </div>
                    ...
                    <div class="d-flex align-items-center mt-2 border-gray border rounded-pill p-2"
                        ...
                        <span class="badge text-dark me-2 fs-6 "
                            ...
                            4.0 <img src="{{ asset('assets/images/ic-star.png') }}" alt="star"
                    ...
                    <div class="text-muted mt-1 d-flex align-items-center" style="font-weight: 500;">
                        <img src="{{ asset('assets/images/ic-location.png') }}" alt="location"
                    ...
                    <div class="">
                        ...
                        <div class="row text-center mb-4">
                            <div class="col-6 col-md-3">
                                <img src="{{ asset('assets/images/dd1.png') }}" alt="gear" class="img-fluid mb-1"
                                    style="width: 32px; height: 32px;">
                                <p class="mb-0 text-muted">Truyền động</p>
                                <p class="fw-semibold">Số sàn</p>
                            </div>
                            <div class="col-6 col-md-3">
                                <img src="{{ asset('assets/images/dd2.png') }}" alt="gear" class="img-fluid mb-1"
                                    style="width: 32px; height: 32px;">
                                <p class="mb-0 text-muted">Số ghế</p>
                                <p class="fw-semibold">4 chỗ</p>
                            </div>
                            <div class="col-6 col-md-3">
                                <img src="{{ asset('assets/images/dd3.png') }}" alt="gear" class="img-fluid mb-1"
                                    style="width: 32px; height: 32px;">
                                <p class="mb-0 text-muted">Nhiên liệu</p>
                                <p class="fw-semibold">Xăng</p>
                            </div>
                            <div class="col-6 col-md-3">
                                <img src="{{ asset('assets/images/dd4.png') }}" alt="gear" class="img-fluid mb-1"
                                    style="width: 32px; height: 32px;">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mb-3 position-relative">
                            <img src="{{ asset('assets/images/banner-detail.png') }}" class="w-100 rounded"
                                alt="banner">
                    ...
                    <div class="container my-4">
                        ...
                        <div class=" p-3 rounded shadow-sm" style="background: #F4F4F4;">
                            ...
                            <div class="border border-success rounded p-2 mb-3 d-flex justify-content-between align-items-center text-success fw-semibold"
                                ...
                                <span><img src="{{ asset('assets/images/elements.png') }}" alt="gift"
                        ...
                        <div class="promotion-list"
                            ...
                            <div class="promotion-item d-flex align-items-center p-3 border rounded mb-3">
                                <div class="ticket-icon me-1">
                                    <img src="{{ asset('assets/images/voucher.png') }}" alt="gift"
        ...
        <script>
            // Car images array
            const carImages = [
                '{{ asset('assets/images/img-car.png') }}',
                '{{ asset('assets/images/16993071-blue-mid-size-urban-family-sedan-white-uniform-background-3d-rendering 1.png') }}',
                '{{ asset('assets/images/img-car.png') }}',
                '{{ asset('assets/images/16993071-blue-mid-size-urban-family-sedan-white-uniform-background-3d-rendering 1.png') }}'
            ];
