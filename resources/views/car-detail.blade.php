...
<body>
  ...
  <div class="d-flex align-items-center mt-2 border-gray border rounded-pill p-2" style="width: fit-content;">
    <span class="badge text-dark me-2 fs-6 " style="border-right: 1px solid #e0e0e0; padding-right: 10px;">
      4.0 <img src="{{ asset('assets/images/ic-star.png') }}" alt="star" class="img-fluid mb-1" style="width: 10px; height: 10px;">
    </span>
  ...
  <div class="text-muted mt-1 d-flex align-items-center" style="font-weight: 500;">
    <img src="{{ asset('assets/images/ic-location.png') }}" alt="location" class="img-fluid mb-1 me-1" style="width: 16px; height: 16px;"> Quận 1, TP Hồ Chí Minh
  </div>
...
<div class="">
  ...
  <div class="row text-center mb-4">
    <div class="col-6 col-md-3">
      <img src="{{ asset('assets/images/dd1.png') }}" alt="gear" class="img-fluid mb-1" style="width: 32px; height: 32px;">
      <p class="mb-0 text-muted">Truyền động</p>
      <p class="fw-semibold">Số sàn</p>
    </div>
    <div class="col-6 col-md-3">
      <img src="{{ asset('assets/images/dd2.png') }}" alt="gear" class="img-fluid mb-1" style="width: 32px; height: 32px;">
      <p class="mb-0 text-muted">Số ghế</p>
      <p class="fw-semibold">4 chỗ</p>
    </div>
    <div class="col-6 col-md-3">
      <img src="{{ asset('assets/images/dd3.png') }}" alt="gear" class="img-fluid mb-1" style="width: 32px; height: 32px;">
      <p class="mb-0 text-muted">Nhiên liệu</p>
      <p class="fw-semibold">Xăng</p>
    </div>
    <div class="col-6 col-md-3">
      <img src="{{ asset('assets/images/dd4.png') }}" alt="gear" class="img-fluid mb-1" style="width: 32px; height: 32px;">
...
<div class="mt-4">
  ...
  <div class="mb-3 position-relative">
    <img src="{{ asset('assets/images/banner-detail.png') }}" class="w-100 rounded" alt="banner">
    <div class="position-absolute top-100 start-50 translate-middle">
      <img src="{{ asset('assets/images/avatar.png') }}" class="rounded-circle border border-3 border-white" alt="avatar">
    </div>
  </div>
        ...
        <div class="d-flex">
          ...
          <div>
           <div class="d-flex align-items-center">
            <img src="{{ asset('assets/images/avatar.png') }}" class="rounded-circle me-2" width="42" height="42" alt="user">
            <div>
...
<div >
  ...
  <div class=" p-3 rounded shadow-sm" style="background: #F4F4F4;">
    ...
    <div class="border border-success rounded p-2 mb-3 d-flex justify-content-between align-items-center text-success fw-semibold" style="background:#f0fdf4; cursor:pointer;" onclick="openPromotionModal()">
      <span><img src="{{ asset('assets/images/elements.png') }}" alt="gift" class="img-fluid me-2" style="width: 20px; height: 20px;"> Mã khuyến mại</span>
