...
@section('title', 'Chuẩn bị xe cho thuê - OTOD')
            ...
            <div class="col-lg-8 col-md-10">
                ...
                <div class="mb-5 mt-2 mt-lg-5">
                    ...
                    <div class="car-icon-container mb-4">
                        <div class="car-icon">
                            <img src="{{ asset('/assets/images/car-prepare-ic.png') }}" alt="">
                        </div>
                    </div>
                ...
                <div class="preparation-steps mb-5">
                    ...
                    <a href="{{ route('car-exterior-photos-prepare-owner') }}" style="text-decoration: none">
                        <div class="step-item mb-3">
                            <div class="step-content">
                                <div class="step-left">
                                    <div class="step-icon">
                                        <img src="{{ asset('/assets/images/picture-ic.png') }}" alt="">
                                    </div>
