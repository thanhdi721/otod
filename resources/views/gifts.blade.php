...
@section('content')
    <div class="container w-100" style="margin-left: auto; max-width: 800px">
        ...
        {{-- Header chính với điểm và lịch sử --}}
        ...
        {{-- Tab Content: Còn hiệu lực --}}
        <div class="tab-content" id="valid-tab">
            {{-- Quà tặng 1 --}}
            <div class="gift-item mb-3">
                <div class="gift-item-content">
                    <img src="{{ asset('/assets/images/voucher-refer.png') }}" alt="Katinat Matcha Latte" class="gift-image">
            ...
            <div class="gift-item mb-3">
                <div class="gift-item-content">
                    <img src="{{ asset('/assets/images/voucher.png') }}" alt="Katinat Matcha Latte" class="gift-image">
                    <div class="gift-details">
                        <div class="gift-title">[Katinat] Thẻ quà tặng Matcha Latte 50.000đ</div>
                        <div class="gift-date-status">
                            <span class="gift-date">HSD: 12/2/2026</span>
            ...
            <div class="gift-item mb-3">
                <div class="gift-item-content">
                    <img src="{{ asset('/assets/images/discount.png') }}" alt="Katinat Matcha Latte" class="gift-image">
                    <div class="gift-details">
                        <div class="gift-title">[Katinat] Thẻ quà tặng Matcha Latte 50.000đ</div>
                        <div class="gift-date-status">
                            <span class="gift-date">HSD: 12/2/2026</span>
        ...
        {{-- Tab Content: Đã sử dụng --}}
        <div class="tab-content d-none" id="used-tab">
            {{-- Quà tặng đã sử dụng 1 --}}
            <div class="gift-item mb-3">
                <div class="gift-item-content">
                    <img src="{{ asset('/assets/images/voucher-refer.png') }}" alt="Katinat Matcha Latte" class="gift-image">
                    <div class="gift-details">
