...
@section('title', 'Home - Laravel Demo Application')
        ...
        <div class="container position-relative">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <img src="{{ asset('assets/images/16993071-blue-mid-size-urban-family-sedan-white-uniform-background-3d-rendering 1.png') }}"
            ...
            <div class="d-flex flex-row gap-3 overflow-x-hidden position-relative">
                ...
                <div style="scroll-snap-align: start;">
                    <div class="card border-0 shadow-sm position-relative overflow-hidden h-100">
                        <img src="{{ asset('assets/images/hcm.png') }}" class="card-img-top object-fit-cover"
                ...
                <div style="scroll-snap-align: start;">
                    <div class="card border-0 shadow-sm position-relative overflow-hidden h-100">
                        <img src="{{ asset('assets/images/hanoi.png') }}" class="card-img-top object-fit-cover"
                ...
                <div style="scroll-snap-align: start;">
                    <div class="card border-0 shadow-sm position-relative overflow-hidden h-100">
                        <img src="{{ asset('assets/images/danang.png') }}" class="card-img-top object-fit-cover"
                ...
                <div style="scroll-snap-align: start;">
                    <div class="card border-0 shadow-sm position-relative overflow-hidden h-100">
                        <img src="{{ asset('assets/images/nhatrang.png') }}" class="card-img-top object-fit-cover"
                ...
                <div class="col-12">
                    <div class="d-flex flex-column flex-md-row align-items-center">
                        ...
                        <div class="bg-light rounded p-4 me-0 me-md-3 mb-3 mb-md-0 d-flex align-items-center justify-content-center"
                            ...
                            <img src="{{ asset('assets/images/car-about.png') }}" alt="">
                        </div>
                        <!-- Text -->
                ...
                <div class="col">
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                        <div class="position-relative">
                            <img src="{{ asset('assets/images/discover.jpg') }}" class="card-img-top object-fit-cover"
            ...
            <div class="card card-border w-100 rounded-4 bg-warning" style="height: 534px;">
                ...
                <div class="d-none d-lg-flex align-items-stretch" style="height: 100%;">
                    <div class="d-flex align-items-center justify-content-center p-4"
                        ...
                        <img src="{{ asset('assets/images/phone.png') }}" alt="" class="img-fluid"
                        ...
                        <div class="bg-white px-4 py-5 d-flex flex-column justify-content-center rounded-4"
                            ...
                            <div class="d-flex gap-3">
                                <a href="#"><img src="{{ asset('/assets/images/appstore.png') }}" alt="App Store"
                                        style="height:40px;"></a>
                                <a href="#"><img src="{{ asset('/assets/images/googleplay.png') }}"
