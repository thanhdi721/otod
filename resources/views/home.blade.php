                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="{{ route('demo.bootstrap') }}" class="btn btn-primary">View Demo</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="{{ route('demo.jquery') }}" class="btn btn-success">View Demo</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="{{ route('demo.vue') }}" class="btn btn-info">View Demo</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="{{ route('demo.charts') }}" class="btn btn-warning">View Demo</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text text-muted">Interactive maps with markers, controls, and real-time updates
                                using Leaflet.js.</p>
                            <a href="{{ route('demo.maps') }}" class="btn btn-danger">View Demo</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text text-muted">Full-featured calendar component with event management and date
                                handling.</p>
                            <a href="{{ route('demo.calendar') }}" class="btn btn-secondary">View Demo</a>
                        </div>
                    </div>
                </div>
            </div>
