...
@section('content')
    <div class="container w-100 mt-4" style="max-width: 800px">
        ...
        <div class="d-flex align-items-center gap-3 mb-3">
            <a href="{{ route('orders') }}" class="text-decoration-none text-muted d-inline-flex align-items-center">
                    ...
                    <div class="d-flex align-items-start gap-3 w-100">
                        ...
                        <div class="w-100">
                            <div class="d-flex align-items-center gap-2 mb-1 w-100">
                                ...
                                <img src="{{ asset('/assets/images/completed-ic.png') }}" alt="" class="rounded">
                            </div>
        ...
        <div class="mb-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <img src="{{ asset('/assets/images/clock-02.png') }}" alt="" class="rounded">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('/assets/images/location-03.png') }}" alt="" class="rounded">
                        <div>
        ...
        <div class="d-flex flex-column gap-3 mt-4">
            <button class="btn btn-save-money d-flex align-items-center justify-content-center gap-2 flex-fill"
                ...
                <img src="{{ asset('/assets/images/save-money-ic.png') }}" alt="" class="rounded">
